(function (global, factory) {
	...
	(factory((global['le5le-store'] = {}),global.ng.core,global.Rx,global.ng.common));
...
exports.CookieService = CookieService_1 = (function () {
...
exports.CookieService = CookieService_1 = __decorate([
    core.Injectable()
...
exports.StoreService = (function () {
    ...
    StoreService.prototype.find$ = function (key, autoAdd) {
        ...
        if (!data) {
            if (!autoAdd)
                return null;
            this.memStore$[key] = new Subject.Subject();
...
exports.StoreService = __decorate$1([
    core.Injectable()
...
exports.Le5leStoreModule = Le5leStoreModule_1 = (function () {
...
exports.Le5leStoreModule = Le5leStoreModule_1 = __decorate$2([
    core.NgModule({
        imports: [common.CommonModule],
        providers: [exports.StoreService]
    }),
    __param(0, core.Optional()), __param(0, core.SkipSelf()),
    __metadata("design:paramtypes", [exports.Le5leStoreModule])
], exports.Le5leStoreModule);
var Le5leStoreModule_1;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=le5le-store.umd.js.map
